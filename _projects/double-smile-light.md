---
title: Double Smile (Light BG Variant)
kind: T-shirt
tagline: Two faces, three eyes, one mood. Black print for light shirts.
cover: /assets/img/double-smile/light-cover.png
cover_style: photo
date: 2026-09-13
topics: [tshirts]
links:
...
This is the black version, for white and other light shirts. There is also a [white version for dark shirts]({{ '/projects/double-smile/' | relative_url }}).
