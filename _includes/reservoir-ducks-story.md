...
<figure class="art {{ include.style }}"><a href="{{ shop.url }}" target="_blank" rel="noopener"><img src="{{ include.art | relative_url }}" alt="Three ducks in suits and red ties walking side by side"></a></figure>
